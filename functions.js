...
function Book(title, author, pages, readYet, location) {
  ...
  this.info = function () {
    const infoString = ` "${this.title}" by ${this.author}, ${this.pages} pages, ${this.readYet}`;
    return infoString;
  };
}
...
const tradHealersCentralAustralia = new Book(
